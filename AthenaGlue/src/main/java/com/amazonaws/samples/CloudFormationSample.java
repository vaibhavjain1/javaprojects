 ...
 * (C:\\Users\\vaibhav.jain\\.aws\\credentials) where the sample code will load the credentials from.
 * <p>
...
public class CloudFormationSample {
    ...
    public static void main(String[] args) throws Exception {
         ...
         * (C:\\Users\\vaibhav.jain\\.aws\\credentials).
         */
        ...
        try {
            ...
            throw new AmazonClientException(
                    ...
                    "location (C:\\Users\\vaibhav.jain\\.aws\\credentials), and is in valid format.",
                    e);
        }
